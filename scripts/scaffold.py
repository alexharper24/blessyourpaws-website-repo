...
@media (max-width:900px){
  ...
  .hero-photo{width:auto;justify-self:auto;margin:0;position:relative;
    aspect-ratio:auto;min-height:min(142vw,34rem);
  ...
  .hero-copy>.eyebrow{grid-row:2;z-index:2;color:var(--rose);margin:0 0 .3rem}
  .hero-copy>h1{grid-row:3;z-index:2;color:#fff;
    text-shadow:0 1px 14px rgba(0,0,0,.45);
    font-size:clamp(1.5rem,7vw,1.9rem);margin:0 0 .1rem}
  .hero-copy>.btn-row{grid-row:4;z-index:2;margin:.9rem 0 0;
