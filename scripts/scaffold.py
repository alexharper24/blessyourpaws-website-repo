...
/* .tri>div paints itself background:var(--card,#fff). On a dark band that fill punches a
   bright block through the middle of the thing the band exists to create, so it goes, and
   the band's own light treatment takes back over. The border goes with it: --rule is a
   pale pink-grey at 8.55:1 on forest and would leave a stark outline around nothing.
