...
open:
  ...
  - {id: g5-kids-fact, gate: G5, blocked_on: alex, item: "The site disagrees with itself about who the puppies are raised around: the breed guide says our own kids, the homepage description says nieces and nephews. Facts about real people, so Alex says which is true and both get made consistent"}
