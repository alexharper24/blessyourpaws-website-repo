...
open:
  ...
  - {id: g5-delivery-states, gate: G5, blocked_on: alex, item: "A delivery-area section naming the states served would capture about 1,300 monthly Bernedoodle searches in Indiana, Michigan, Ohio and Illinois, but which states Furry Freight actually covers is unknown. Naming states not served would be a false claim"}
  - {id: g5-eyebrow-contrast, gate: G5, blocked_on: alex, item: "Site-wide eyebrow labels in --sage-deep measure 4.34:1 on paper and 4.11:1 on the band-raise tint, under WCAG's 4.5:1 for small text. A design-system decision, pre-existing on every page"}
